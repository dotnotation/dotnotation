...
<p>Hi! My name is Dorthy Thielsen and I am a lead UI/UX full stack software engineer. I currently am working at The Brandit Agency/MarketFuel. I am in charge of making all UI/UX decisions on our platform. I also am a bug squasher and have implemented Auth0 into our platform. Another accomplishment is creating a reuseable log component that is utilized in many areas of our platform. I primarily work in Ruby and Javascript. My pronouns are she/her. I have a background in graphic design and puppet fabrication which gives me a lot of experience with collaborating, problem solving, making aesthetically pleasing designs, and thinking about the user experience first.</p>

<h3>Currently working on:</h3>
<p>I currently working on getting UI/UX certificate from Baymard. I am studing algorithms and data structures, learning TypeScript and writing rspec in my spare time. I want to focus on learning more about accessibility and getting certified by the International Association of Accessibility Professionals. I still have so much to learn and that is exciting.</p>
